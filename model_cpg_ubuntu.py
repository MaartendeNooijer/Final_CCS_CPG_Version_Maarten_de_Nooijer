...
from Adjusted_Darts_Files.cpg_reservoir_ubuntu import CPG_Reservoir, save_array, read_arrays, check_arrays, make_burden_layers, make_full_cube
...
from Adjusted_Darts_Files.cicd_model_ubuntu import CICDModel #NEW
...
class Model_CPG(CICDModel):
    ...
    def init_reservoir(self):
        ...
        mask_shale = (satnum_active == 3)  # & (global_to_local >= 0)
        mask_sand = ((satnum_active == 1) | (satnum_active == 2))  # & (global_to_local >= 0)
